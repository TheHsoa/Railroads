package pers.rasskazov.huawei.testfoqacandidate.checkers;
...
public final class TrainCoachesReorganizationChecker {
    ...
    private static boolean tryMoveTrainCoachesToStationBeforeFindNextCoach(Stack<Integer> trainCoaches, Stack<Integer> stationTrainCoaches, int nextSearchedTrainCoach) {
